        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 mb-32">
          ...
          <div className="lg:col-span-4 flex flex-col justify-between">
            ...
            <div className="flex items-center gap-4 text-slate-400">
              ...
              <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="hover:text-brand-navy transition-colors" aria-label="Instagram">
              ...
              <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="hover:text-brand-navy transition-colors" aria-label="LinkedIn">
