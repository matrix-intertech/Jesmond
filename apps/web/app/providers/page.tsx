      ...
      <main className="pb-24">
        ...
        <section className="relative w-full py-24 lg:py-32 bg-white overflow-hidden border-b border-slate-200">
          ...
          <div className="max-w-[1440px] mx-auto px-6 sm:px-12 lg:px-16 relative z-10 text-center max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-7xl font-medium text-slate-900 mb-8 tracking-tight leading-[1.1]" style={{ fontFamily: 'var(--font-outfit)' }}>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Link href="/portal" className="px-8 py-4 bg-slate-900 text-white rounded-xl hover:bg-slate-800 transition-colors font-medium shadow-lg w-full sm:w-auto">
                Provider Portal
              </Link>
              <Link href="/contact" className="px-8 py-4 bg-white text-slate-900 border border-slate-200 rounded-xl hover:bg-slate-50 transition-colors font-medium w-full sm:w-auto">
                Contact Sales
              </Link>
            </div>
          </div>
        ...
        <section className="py-24 max-w-[1440px] mx-auto px-6 sm:px-12 lg:px-16">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-center">
            <div>
              ...
              <h3 className="text-xl font-bold text-slate-900 mb-3">Reach Students</h3>
            ...
            <div>
              ...
              <h3 className="text-xl font-bold text-slate-900 mb-3">Manage Properties</h3>
            ...
            <div>
              ...
              <h3 className="text-xl font-bold text-slate-900 mb-3">Verified Applications</h3>
        ...
        <section className="py-24 bg-white max-w-[1440px] mx-auto px-6 sm:px-12 lg:px-16 border-t border-slate-200">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-medium text-slate-900 mb-4" style={{ fontFamily: 'var(--font-outfit)' }}>
              Trusted Partners
            </h2>
          ...
          {error ? (
            <div className="bg-slate-50 border border-red-100 rounded-[24px] p-12 text-center max-w-2xl mx-auto shadow-sm">
              ...
              <h3 className="text-2xl font-semibold text-slate-900 mb-2">Service Temporarily Unavailable</h3>
            ...
            <div className="bg-slate-50 border border-slate-200 rounded-[24px] p-12 max-w-2xl mx-auto shadow-sm">
              <EmptyState
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {providers.map((provider: OrganizationRecord) => (
                <div key={provider.id} className="group bg-slate-50 border border-slate-200 rounded-[24px] p-8 hover:shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:border-indigo-100 transition-all duration-300 flex flex-col justify-between items-start">
